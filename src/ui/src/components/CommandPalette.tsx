...
export function useDefaultCommands(options: {
  ...
  return useMemo(() => [
    ...
    {
      id: 'nav-search-advanced',
      title: t('nav.searchAdvanced', 'Advanced Search'),
      description: t('commandPalette.openAdvancedSearch', 'Open advanced search'),
      icon: <Tune />,
      category: 'navigation' as const,
      action: () => navigate('/search-advanced'),
    },
    {
      id: 'nav-artist-lookup',
      title: t('nav.artistLookup', 'Artist Lookup'),
      description: t('commandPalette.openArtistLookup', 'Search with artist lookup providers'),
      icon: <Search />,
      category: 'navigation' as const,
      action: () => navigate('/artist-lookup'),
    },
    {
      id: 'nav-requests',
      title: t('nav.requests', 'Requests'),
      description: t('commandPalette.openRequests', 'Open request center'),
      icon: <Public />,
      category: 'navigation' as const,
    ...
    },
    {
      ...
      description: t('commandPalette.openAnalytics', 'Open analytics'),
      icon: <Timeline />,
      category: 'navigation' as const,
      action: () => navigate('/analytics'),
    },
    {
      id: 'nav-playback-tools',
      title: t('nav.playbackTools', 'Playback Tools'),
      description: t('commandPalette.openPlaybackTools', 'Open playback tools'),
      icon: <Rule />,
      category: 'navigation' as const,
      action: () => navigate('/playback-tools'),
    },
    {
      id: 'nav-playlists',
    ...
    {
      id: 'nav-admin-users',
      title: t('nav.adminUsers', 'Admin Users'),
      description: t('commandPalette.openAdminUsers', 'Manage admin users'),
